...
bool HelloWorld::init()
{
	...
	gameItem->setColor(Color3B::BLUE);
	helpItem->setColor(Color3B::BLUE);
	aboutItem->setColor(Color3B::BLUE);
	gameItem->setTag(11);
	helpItem->setTag(12);
	aboutItem->setTag(13);
...
void HelloWorld::menuCloseCallback(Ref* pSender)
{
	...
	case 11://game
		Director::getInstance()->replaceScene(TransitionFadeTR::create(1, GameScene::createScene()));
			break;
	case 12://help
		Director::getInstance()->replaceScene(TransitionFadeTR::create(1, HelpScene::createScene()));
			break;
	case 13://about
		Director::getInstance()->replaceScene(TransitionFadeTR::create(1, AboutScene::createScene()));
			break;
